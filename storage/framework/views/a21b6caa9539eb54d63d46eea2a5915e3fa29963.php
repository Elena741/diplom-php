<?php $__env->startSection('content'); ?>
	<div class="container">
		...
		<hr>
		<a href="<?php echo e(route('admin.category.create')); ?>" class="btn btn-primary pull-right">Создать категорию</a>
				...
				<?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					<tr>
						...
						<td class="text-right">
							...
							<a class="btn btn-default" href="<?php echo e(route('admin.category.edit', $category)); ?>"><i class="fa fa-edit"></i></a>	
